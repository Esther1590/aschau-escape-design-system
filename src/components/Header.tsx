      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/" className={`font-medium transition-colors hover:text-wellness-sage ${isActive('/') ? 'text-wellness-sage' : 'text-gray-700 dark:text-gray-200'}`}>
              {language === 'EN' ? 'Home' : 'Startseite'}
            </Link>
            <Link to="/wellness" className={`font-medium transition-colors hover:text-wellness-sage ${isActive('/wellness') ? 'text-wellness-sage' : 'text-gray-700 dark:text-gray-200'}`}>
              {t('nav.wellness')}
            </Link>
          ...
          <div className="flex items-center space-x-4">
            <ThemeToggle />
            <Button variant="ghost" size="sm" onClick={toggleLanguage} className="flex items-center space-x-1 text-gray-700 dark:text-gray-200 hover:text-wellness-sage">
        ...
        {isMenuOpen && (
          <nav className="md:hidden mt-4 pb-4 border-t border-gray-200 dark:border-gray-700 pt-4">
            <div className="flex flex-col space-y-4">
              ...
              <Link to="/wellness" className={`font-medium transition-colors hover:text-wellness-sage ${isActive('/wellness') ? 'text-wellness-sage' : 'text-gray-700 dark:text-gray-200'}`} onClick={() => setIsMenuOpen(false)}>
                {t('nav.wellness')}
              </Link>
